...
describe("trait and spell implementation markers match their data", () => {
  ...
  it("records how much of the trait section carries no rules", async () => {
    ...
    // 399 of 584. The spellcasting slots task authored the nine slot-casting
    // classes' Spellcasting traits, each replacing an "unimplemented" stub of
    // the same id (deleted from traits/unimplemented.json, upserted with real
    // resources into its class's own segment) - a wash on the total count,
    // nine fewer rule-free.
