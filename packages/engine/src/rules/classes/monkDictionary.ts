...
export const MONK_CLASS: ClassDefinition = {
  ...
  startingProficiencyTraitIds: [
    ...
    "trait_monk_prof_tools",
    "trait_monk_prof_skills",
  ],
  progression: [
    {
      level: 1,
      grants: ["trait_unarmored_defense_monk", "trait_martial_arts"],
      grantsASI: false,
    },
    {
      level: 2,
      grants: ["trait_ki", "trait_unarmored_movement"],
      grantsASI: false,
    },
    {
      level: 3,
      grants: ["trait_monastic_tradition", "trait_deflect_missiles"],
      grantsASI: false,
    },
    {
      level: 4,
      grants: ["trait_slow_fall"],
      grantsASI: true,
    },
    {
      level: 5,
      grants: ["trait_extra_attack", "trait_stunning_strike"],
      grantsASI: false,
    },
    {
      level: 6,
      grants: [
        "trait_ki_empowered_strikes",
        "trait_monastic_tradition_feature",
      ],
      grantsASI: false,
    },
    {
      level: 7,
      grants: ["trait_evasion_monk", "trait_stillness_of_mind"],
      grantsASI: false,
    },
    { level: 8, grants: [], grantsASI: true },
    {
      level: 9,
      grants: ["trait_unarmored_movement_improvement"],
      grantsASI: false,
    },
    {
      level: 10,
      grants: ["trait_purity_of_body"],
      grantsASI: false,
    },
    {
      level: 11,
      grants: ["trait_monastic_tradition_feature"],
      grantsASI: false,
    },
    { level: 12, grants: [], grantsASI: true },
    {
      level: 13,
      grants: ["trait_tongue_of_the_sun_and_moon"],
      grantsASI: false,
    },
    {
      level: 14,
      grants: ["trait_diamond_soul"],
      grantsASI: false,
    },
    {
      level: 15,
      grants: ["trait_timeless_body"],
      grantsASI: false,
    },
    ...
    {
      level: 18,
      grants: ["trait_empty_body"],
      grantsASI: false,
    },
    { level: 19, grants: [], grantsASI: true },
    {
      level: 20,
      grants: ["trait_perfect_self"],
      grantsASI: false,
    },
  ],
};

export const MONK_SUBCLASSES: Record<string, SubclassDefinition> = {
  subclass_monk_four_elements: {
    id: "subclass_monk_four_elements",
    classId: "class_monk",
  ...
  subclass_monk_open_hand: {
    ...
    progression: [
      {
        level: 3,
        grants: ["trait_open_hand_technique"],
      },
      {
        level: 6,
        grants: ["trait_wholeness_of_body"],
      },
      {
        level: 11,
        grants: ["trait_tranquility"],
      },
      {
        level: 17,
        grants: ["trait_quivering_palm"],
      },
    ],
  },
  subclass_monk_shadow: {
    id: "subclass_monk_shadow",
    classId: "class_monk",
    name: "Way of Shadow",
    progression: [
      {
        level: 3,
        grants: ["trait_shadow_arts"],
      },
      {
        level: 6,
        grants: ["trait_shadow_step"],
      },
      {
        level: 11,
        grants: ["trait_cloak_of_shadows"],
      },
      {
        level: 17,
        grants: ["trait_opportunist"],
      },
    ],
  },
};
